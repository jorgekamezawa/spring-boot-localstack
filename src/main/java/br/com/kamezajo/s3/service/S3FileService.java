package br.com.kamezajo.s3.service;

import br.com.kamezajo.s3.exception.FileListenerException;
...
public class S3FileService {
    ...
    public List<Resource> searchFile(String name, boolean exact) {
        ...
        return Arrays.stream(resources).sorted(Comparator.comparing(Resource::getFilename)).collect(Collectors.toList());
    }
